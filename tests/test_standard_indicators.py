...
def test_single_simple_moving_average():
    assert PyTechnicalIndicators.standard_indicators.single.simple_moving_average(prices) == 210.7058823529412

def test_bulk_simple_moving_average():
    assert PyTechnicalIndicators.standard_indicators.bulk.simple_moving_average(prices, 30) == [208.56666666666666, 209.73333333333332, 210.36666666666667, 211.03333333333333, 211.96666666666667]

def test_single_smoothed_moving_average():
    assert PyTechnicalIndicators.standard_indicators.single.smoothed_moving_average(prices) == 214.20874647478678

def test_bulk_smoothed_moving_average():
    assert PyTechnicalIndicators.standard_indicators.bulk.smoothed_moving_average(prices, 30) == [211.97920123916037, 213.40755601685768, 214.28612990851622, 215.02097023671016, 215.64906708402194]

def test_single_exponential_moving_average():
    assert PyTechnicalIndicators.standard_indicators.single.exponential_moving_average(prices) == 217.38500644771585

def test_bulk_exponential_moving_average():
    assert PyTechnicalIndicators.standard_indicators.bulk.exponential_moving_average(prices, 30) == [215.29552232471173, 216.91990305584258, 217.89096009276992, 218.55139303267376, 218.79831857416528]

def test_single_bollinger_bands():
    assert PyTechnicalIndicators.standard_indicators.single.bollinger_bands(prices[:20]) == (175.05324174971474, 203.2, 231.34675825028523)

def test_bulk_bollinger_bands():
    assert PyTechnicalIndicators.standard_indicators.bulk.bollinger_bands(prices) == [
...
def test_single_macd():
    assert PyTechnicalIndicators.standard_indicators.single.macd(prices) == (6.8523139433706035, 7.639538247944125, -0.7872243045735212)

def test_bulk_macd():
    assert PyTechnicalIndicators.standard_indicators.bulk.macd(prices) == [(6.8523139433706035, 7.639538247944125, -0.7872243045735212)]

def test_single_rsi():
    assert PyTechnicalIndicators.standard_indicators.single.rsi(prices[:14]) == 42.592077184575366

def test_bulk_rsi():
    assert PyTechnicalIndicators.standard_indicators.bulk.rsi(prices) == [
